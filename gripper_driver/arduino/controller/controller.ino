 ...
 */
 ...
 void loop()
 {
   ...
   if(flag1==1)
   {
    ...
    digitalWrite(28,setpoint_gripper1.data[0]);
    digitalWrite(34,setpoint_gripper1.data[1]);
    digitalWrite(40,setpoint_gripper1.data[2]);
    digitalWrite(46,setpoint_gripper1.data[3]);
    digitalWrite(52,setpoint_gripper1.data[4]);
