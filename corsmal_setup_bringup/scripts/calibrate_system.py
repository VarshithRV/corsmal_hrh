...
def calibrate_right_camera():
    ...
    rospy.loginfo(f"Transformation of right camera successfull, written into file config/{right_camera_calibration_target_file_name}")
...
if __name__ == "__main__":
    ...
    calibrate_robot()
    print("################################################################")
    rospy.loginfo("Waiting to detect the common frame using the left camera")
    rospy.wait_for_message("/left_camera_object_filtered_pose",PoseStamped)
    calibrate_left_camera()
    print("################################################################")
    rospy.loginfo("Waiting to detect the common frame using the right camera")
    rospy.wait_for_message("/right_camera_object_filtered_pose",PoseStamped)
    calibrate_right_camera()
    print("################################################################")
    rospy.spin()
